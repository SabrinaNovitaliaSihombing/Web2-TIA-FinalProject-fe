        ...
        <div className="pt-2 pb-3 space-y-1">
          ...
          {isAuthenticated ? (
            ...
            <>
              ...
              <Link
                to="/register"
                className="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-blue-500 hover:text-blue-700 hover:bg-gray-50 hover:border-blue-300"
              >
                Register
              </Link>
            </>
